    ...
    return (
        <div className="home-container">
            <div className="home-intro">
                ...
                <h1>Smart Credit Card<br></br>For Your Daily Life</h1>
                <button className="btn" type="download">Download <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-down-circle" viewBox="0 0 16 16">
            ...
            <div className="home-phone">
                <div className="home-phone-container">
                    ...
                    <div className="phone-transaction-history-container">
                                ...
                                <li>
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <span className="transaction-type">Subscription</span>
                                        </div>
                                    </div>
                                    <span>$50</span>
                                </li>
                    ...
                    <div className="phone-bottom-nav-container">
